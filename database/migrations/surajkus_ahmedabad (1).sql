...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 26, 2020 at 07:13 PM
...
(1, 'hoga kuch', 380000, 'AHMEDABAD', 'user', 'gujarat', NULL, '2020-02-26 10:50:58');
...
(1, 'Lights', 'Rice light', 500, 20, 1, NULL, NULL);
...
INSERT INTO `temps` (`id`, `name`, `enroll`) VALUES
(3, 'suraj', 123456);
...
INSERT INTO `users` (`id`, `name`, `email`, `address_id`, `Phone_no`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'Suraj', 'skk74143@gmail.com', 1, 1234656, NULL, '$2y$10$trJGgGwhyrdon5CsQjKZ2u8pzx0Zz/YPLF3RCN9v481jf/gjN8Lca', NULL, '2020-02-02 01:44:57', '2020-02-26 10:50:58'),
(2, 'Karan kushwaha', 'karan123@outlook.com', NULL, 58692562, NULL, '$2y$10$n8HO.oFxr1/bYTIBYcWDfe6lN/Vt9nIx/KO0QwNYzzALAqNpUxYeO', NULL, '2020-02-16 02:37:20', '2020-02-24 06:14:24');
